...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<Void> handleNotReadable(HttpMessageNotReadableException e) {
        return ApiResponse.error(ErrorCode.BAD_REQUEST, "请求体格式错误: " + e.getMostSpecificCause().getMessage());
    }
    ...
    public ApiResponse<Void> handleTypeMismatch(MethodArgumentTypeMismatchException e) {
        return ApiResponse.error(ErrorCode.BAD_REQUEST,
            "参数类型错误: " + e.getName() + " 期望 " + (e.getRequiredType() != null ? e.getRequiredType().getSimpleName() : "未知"));
    }
